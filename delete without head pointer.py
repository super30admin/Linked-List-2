...
# TC: O(1), as no traversal is required.
# SC: O(1), no extra space is used.
#problem: Is it bad that I did not even know where to beginw with
#may be Im just too dumb for this ;( orr I have long way to go, #keepLearning
