...
/* 
 * We need to assign the next data value to current node and then just change the next reference values.
*/
//{ Driver Code Starts
import java.util.*;
...
class Solution
{
    ...
    {
         // Your code here
        // chnge the current data value to next and move the data 1 step 
